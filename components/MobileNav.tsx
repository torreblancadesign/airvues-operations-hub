...
const ICONS: Record<string, React.ReactNode> = {
  ...
  "/loops": I(<><rect x="3" y="5" width="18" height="14" rx="3" ry="3" /><polygon points="10 9 16 12 10 15 10 9" fill="currentColor" stroke="none" /></>),
  ...
  "/engineering/retainer-timesheets": I(<><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>),
  ...
  "/founder": I(<><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /></>),
};
