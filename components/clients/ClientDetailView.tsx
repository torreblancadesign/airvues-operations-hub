      ...
      >
        ...
        <div className="if-group mt-4 pt-4 border-t border-rule [&_.border-b]:border-b-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-4">
            <InlineField
              kind="textarea" label="Relationship notes" value={detail.relationshipNotes} rows={4}
              placeholder="How they like to be worked with — communication, dynamics, recurring concerns."
            ...
            />
            <InlineField
              kind="textarea" label="Legal address" value={detail.legalAddress ?? ""} rows={4}
